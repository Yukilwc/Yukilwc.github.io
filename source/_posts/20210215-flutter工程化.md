...
// 升级flutter sdk，大概率卡死，也可以直接使用git指令更新,但是这样会缺少大量的android工程相关的更新下载
// 同时也会更新flutter项目依赖包,如果宽带炸了，可以手机开热点用流量试试哦
// 会触发 1 dart sdk下载 2 flutter tool下载 3 pub upgrade 4 flutter channel 5 flutter doctor
flutter upgrade
...
![Flutter分支更新流程](https://blog-misaka1033.oss-cn-beijing.aliyuncs.com/blog/images/微信图片_20210305201103.png)
...
Flutter SDK Path
* 配置位置：如果是新工程，在创建时会询问配置位置,否则 setting-language&frameworks-flutter-flutter sdk path
* 配置内容：D:\software\flutter


Dart SDK位置

* 配置位置： setting-language&frameworks-dart-dart SDK Path
* 配置内容：D:\software\flutter\bin\cache\dart-sdk
...
1. 第一次跑flutter项目，会进行环境配置，会进行gradle,远程下载gradle被墙了,大概率卡死.[Gradle问题参考](https://blog.csdn.net/qq_41976613/article/details/104394870)
...
2. Android Studio具体要下载哪些？ 只是安装了android studio，那android sdk，AVD manager会后续自动安装吗，还是需要独立下载安装? 
...
仅介绍简单目录，各种深层嵌套的目录后续了解后添加

![目录结构](https://blog-misaka1033.oss-cn-beijing.aliyuncs.com/blog/images/微信图片_20210228144401.png)
